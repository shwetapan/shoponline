...
class ProfileView(View):
  ...
  def post(self,request):
    ...
    if form.is_valid():
      ...
      reg=Customer(user=usr,name=name,city=city,state=state,zipcode=zipcode)
      reg.save()
...
def checkout(request):
  ...
  if request.user.is_authenticated:
    totalitem = len(Cart.objects.filter(user=request.user))
  return render(request, 'app/checkout.html', {'add':add, 'total_amount':totalamount,'cart_items':cart_items,'totalitem':totalitem})
